      ...
      const res = await fetch('/api/rsvp', {
        ...
        body: JSON.stringify({
          ...
          plusOneDrinkPreference:
            hasLinkedGuest && plusOneAttendance === 'yes'
              ? plusOneDrinkPreference
              : undefined,
        }),
      })
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-8 sm:mt-12 sm:space-y-10">
            <fieldset>
              ...
              <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-center sm:gap-8">
                {[
                  ...
                  <label
                    key={option.id}
                    htmlFor={option.id}
                    className="flex items-center justify-center gap-3 rounded-xl border border-stone-200 bg-white/70 px-4 py-3 text-sm text-gray-700"
                  >
                    <input
                      id={option.id}
                      name="attendance"
            ...
            <div>
              ...
              <input
                ...
                className="mt-3 block w-full rounded-xl bg-white/85 px-4 py-3 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-stone-900"
              ...
              <>
                  ...
                  <div className="mt-4 space-y-3">
                    {dietaryOptions.map((option) => (
                      <label
                        ...
                        className="flex items-center gap-3 rounded-xl border border-stone-200 bg-white/70 px-4 py-3 text-sm text-gray-700"
                      >
                        <input
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-3 block w-full rounded-xl bg-white/85 px-4 py-3 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-stone-900"
                    required
                  >
                ...
                {hasLinkedGuest && (
                  <div className="space-y-6 rounded-2xl border border-stone-200 bg-white/65 p-4 backdrop-blur-sm sm:p-6">
                    <div>
                          ...
                          {plusOneDietary === 'other' && (
                            <div className="mt-6">
                              ...
                              <textarea
                                ...
                                placeholder="Any allergies, religious requirements, or other dietary notes"
                                required={
                                  plusOneAttendance === 'yes' && plusOneDietary === 'other'
                                }
                              />
                            </div>
                          )}
            ...
            <div className="pt-2 text-center">
              <button
                ...
                className="w-full rounded-xl bg-stone-900 px-6 py-3.5 text-sm font-semibold text-white transition hover:bg-stone-800 disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
              >
